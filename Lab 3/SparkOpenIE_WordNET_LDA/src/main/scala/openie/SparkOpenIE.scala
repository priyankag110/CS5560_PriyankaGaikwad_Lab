...
object SparkOpenIE {
  ...
  def main(args: Array[String]) {
    ...
    val writer= new BufferedWriter(new FileWriter("data/newAbstracts/abstract9_triplet_output1.txt"));
    ...
    val out =new PrintStream("SubjectsList2.txt")
    ...
    val out1 =new PrintStream("PredicatesList2.txt")
    ...
    val out2 =new PrintStream("ObjectsList2.txt")
    ...
    val out3 =new PrintStream("AllSPOList2.txt")
