...
object OntContructorMain {
  def main(args: Array[String]): Unit = {
    ...
    val ONTOLOGYURI="http://www.semanticweb.org/priyanka/ontologies/2018/11/"
    ...
    val classes=Source.fromFile("BreastCancer/Classes").getLines()
    ...
    val subClasses=Source.fromFile("BreastCancer/SubClasses").getLines()
    ...
    val objprop=Source.fromFile("BreastCancer/ObjectProperties").getLines()
    objprop.foreach(f=> {
      val farr=f.split(",")
    ...
    val dataprop=Source.fromFile("BreastCancer/DataProperties").getLines()
    ...
    val individuals=Source.fromFile("BreastCancer/Individuals").getLines()
    ...
    val triplets=Source.fromFile("BreastCancer/Triplets").getLines()
    triplets.foreach(f=>{
      val farr=f.split(",")
    ...
    val os = new FileOutputStream("BreastCancer/Cancer.owl")
