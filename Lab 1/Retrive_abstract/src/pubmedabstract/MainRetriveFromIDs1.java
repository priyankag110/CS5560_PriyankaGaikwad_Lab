...
public class MainRetriveFromIDs1 {
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            URL url = new URL("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&term=breast%20cancer%20treatment" + "&retmax=1000");
            ...
            String d;
            File f = new File("new_data_alzimers//ids.xml");
